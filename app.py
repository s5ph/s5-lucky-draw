...
.winner-name { font-size:{font_size}px; color:{font_color}; margin:0; z-index:4; font-weight:bold; }px; color:{font_color}; margin:0; transform: translateY({winner_offset}px); z-index:4; font-weight:bold; }}
