# Random Winner Picker – Fully Fixed, Functional, and Centered
...
.winner-name { font-size:${font_size}px; color:${font_color}; margin:0; z-index:4; font-weight:bold; }px; color:{font_color}; margin:0; padding-top:{winner_offset}px; z-index:4; font-weight:bold; }}
.timer {{ font-size:24px; color:{font_color}; margin:0; position:absolute; bottom:20px; z-index:3; }}
</style>
"""
...
if start_draw and csv_up:
    ...
    # Prepare HTML for background and logo
    bg_html = ""
